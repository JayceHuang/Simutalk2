...
public class InterpretView {
	...
	private ImageButton mBtnRecord, btn_bg;
	...
	private int[] recordViewArr = new int[] { R.drawable.bottorm_button_recording1,
			R.drawable.bottorm_button_recording2, R.drawable.bottorm_button_recording3,
			R.drawable.bottorm_button_recording4, R.drawable.bottorm_button_recording5,
			R.drawable.bottorm_button_recording6, R.drawable.bottorm_button_recording7,
			R.drawable.bottorm_button_recording8 };
	...
	// =====================================================================
	public InterpretView(Context context, Handler handler, View v, OnClickListener mOnClickListener) {
		...
		imageWaite.setBackgroundResource(R.drawable.recognizer_wait_anim);
	...
	public InterpretView(Context context, Handler handler, OnClickListener mOnClickListener) {
	...
	public void clearViewAnim() {
		...
		mBtnRecord.setBackgroundResource(R.drawable.trans_bottorm_button_speak);
