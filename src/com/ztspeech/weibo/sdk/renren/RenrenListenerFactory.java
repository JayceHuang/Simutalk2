...
class RenrenListenerFactory {
	...
	static RenrenDialogListener genFeedRenrenDialogListener(final Renren renren, final RenrenFeedListener listener) {
		return new AbstractRenrenDialogListener() {

			@Override
			public void onReceivedError(int errorCode, String description, String failingUrl) {
				listener.onError(new RenrenAuthError(String.valueOf(errorCode), description, failingUrl));
			}
	...
	static RenrenDialogListener genRenrenWidgetDialogListener(final Renren renren, final RenrenWidgetListener listener) {
		return new AbstractRenrenDialogListener() {
	...
	static RenrenDialogListener genUserAgentFlowRenrenDialogListener(final Renren renren,
		...
		return new AbstractRenrenDialogListener() {
			...
			@Override
			public void onReceivedError(int errorCode, String description, String failingUrl) {
				listener.onRenrenAuthError(new RenrenAuthError(String.valueOf(errorCode), description, failingUrl));
			}
			...
			private void authComplete(Bundle values) {
				...
				if (accessToken != null) {
					...
					try {
						...
						e.printStackTrace();
						listener.onRenrenAuthError(new RenrenAuthError(e.getClass().getName(), e.getMessage(), e
								.toString()));
					}
				}
			}
