 ...
 * description字段会提示给用户
 * <p>
 * payment字段是留给开发者设置的字段 人人服务器会原封不动的传回来或者缀在回调应用服务器的参数后面 供开发者验证确认是哪个订单使用
 * <p>
 * iPayListener 务必要实例化该接口，否则支付成功后将没有任何方法通知您的程序
 * <p>
 * 返回订单使用 PayOrder对象
 * 
 * @see PayOrder *
...
public class Payment {
	...
	/**
	 * 订单号开发者可以不设置，这种情况下会去开发者设置的服务器地址上抓取一个订单号 为了兼容之前的人人豆的支付流程
