package com.ztspeech.weibo.sdk.renren.pay.util;
...
public final class PayUtil {
	 ...
	 */
	public static String generateOrderDatas(String appId, String appSecert, String accessToken, String orderNumber,
			int amount, String desc, String payment) {
		...
		params.putString("app_encode", getAppCode(appId, orderNumber, appSecert, timeString));
	 ...
	 * @return
	 */
	public static String generateRepairDatas(String bid, String appId, String orderNumber, int amount,
			String appSecret, String accessToken, long userId, long orderTime) {
		Bundle params = new Bundle();
		params.putString("amount", String.valueOf(amount));
		...
		params.putString("fix_encode", getRepairFixCode(userId, appId, orderNumber, amount, appSecret, orderTime));
		return Util.encodeUrl(params);

	}

	public static String getRepairFixCode(long userId, String appId, String orderNumber, int amount, String appSecret,
			long time) {
		return Util.md5("" + userId + appId + orderNumber + amount + time + appSecret + "");
	}
	 ...
	 * @return
	 */
	public static String getAppCode(String appId, String orderNumber, String appSecert, String time) {
	...
	public static RenrenError parsePayError(String url) {
		...
		if (b.containsKey("error")) {
			eb = new RenrenError(Integer.parseInt(b.getString("error")), b.getString("description"), url);
		}
		return eb;
	}
	 ...
	 * @param requestUri
	 */
	public static void request(final Executor pool, final Bundle parameters, final String requestUri,
