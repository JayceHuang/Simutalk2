...
public class PayStoreHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE_SQL = "CREATE TABLE " + TABLE_NAME + " ("
			+ " orderNumber varchar(21) primary key ," + " appId varchar(11) NOT NULL ,"
			+ " amount integer unsigned NOT NULL ," + " userId integer unsigned NOT NULL ," + " payment varchar(255),"
			+ " bid varchar(32)," + " descr varchar(255)," + " payResultEncode varchar(32),"
			+ " payStatusCode integer NOT NULL," + " dealTime bigint," + " orderTime bigint NOT NULL, "
			+ " serverState tinyint NOT NULL," + " sandBox boolean NOT NULL," + " localEncode varchar(32) NOT NULL"
			+ ");";
	...
	public Cursor select(String[] columns, String selection, String[] selectionArgs, String groupBy, String having,
			String orderBy) {
	...
	public List<PayOrder> getPayOrder(int appId, int userId) {
		...
		Cursor cur = select(null, selectSql, selectArgs, null, null, "orderTime desc");
		// 如果游标没有在开始之前，没有在结束之后
