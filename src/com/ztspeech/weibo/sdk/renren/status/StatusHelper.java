...
public class StatusHelper {
	...
	public void asyncPublish(Executor pool, final StatusSetRequestParam status,
			final AbstractRequestListener<StatusSetResponseBean> listener, final boolean truncOption) {
	...
	public void startStatusPubWidget(String appID, Activity activity,
		...
		renren.widgetDialog(activity, params, new RenrenWidgetListener() {
			...
			public void onCancel(Bundle retParams) {
				...
				if (listener != null) {
					listener.onRenrenError(new RenrenError(RenrenError.ERROR_CODE_OPERATION_CANCELLED, errorMsg,
							errorMsg));
				}
			}
		}, "status");
