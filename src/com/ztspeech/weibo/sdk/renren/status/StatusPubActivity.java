 ...
 * <p>
 * Intent intent = new Intent(activityA, StatusPubActivity.class);
 * <p>
 ...
 * 若需传入Status对象进行编辑和发送，则需要使用类似上述方式将Status对象以Parcel方式 传递给该activity
 * 
...
public class StatusPubActivity extends AbstractRenrenRequestActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AuthorizationHelper.check(renren, this, StatusHelper.PUBLISH_STATUS_PERMISSIONS, new RenrenAuthListener() {
			...
			public void onRenrenAuthError(RenrenAuthError renrenAuthError) {
				showToast(StatusPubActivity.this.getString(R.string.renren_sdk_status_publish_failed));
