...
import com.ztspeech.weibo.sdk.renren.bean.FeedParam;
...
import com.ztspeech.weibo.sdk.renren.feed.FeedHelper;
...
import com.ztspeech.weibo.sdk.renren.friends.FriendsGetFriendsRequestParam;
import com.ztspeech.weibo.sdk.renren.friends.FriendsGetFriendsResponseBean;
import com.ztspeech.weibo.sdk.renren.friends.FriendsGetRequestParam;
import com.ztspeech.weibo.sdk.renren.friends.FriendsGetResponseBean;
import com.ztspeech.weibo.sdk.renren.friends.FriendsHelper;
...
import com.ztspeech.weibo.sdk.renren.photos.AlbumCreateRequestParam;
import com.ztspeech.weibo.sdk.renren.photos.AlbumCreateResponseBean;
import com.ztspeech.weibo.sdk.renren.photos.AlbumGetRequestParam;
import com.ztspeech.weibo.sdk.renren.photos.AlbumGetResponseBean;
import com.ztspeech.weibo.sdk.renren.photos.PhotoHelper;
import com.ztspeech.weibo.sdk.renren.photos.PhotoUploadRequestParam;
import com.ztspeech.weibo.sdk.renren.photos.PhotoUploadResponseBean;
import com.ztspeech.weibo.sdk.renren.status.StatusHelper;
import com.ztspeech.weibo.sdk.renren.status.StatusSetRequestParam;
import com.ztspeech.weibo.sdk.renren.status.StatusSetResponseBean;
import com.ztspeech.weibo.sdk.renren.users.UsersGetInfoHelper;
...
import com.ztspeech.weibo.sdk.renren.view.RenrenDialogListener;
import com.ztspeech.weibo.sdk.renren.view.RenrenFeedListener;
...
public class Renren implements Parcelable {
	 ...
	 * 人人登录和授权的地址
	 */
	public static final String AUTHORIZE_URL = "http://graph.renren.com/oauth/authorize";
	...
	private static final String[] DEFAULT_PERMISSIONS = { "publish_feed", "create_album", "photo_upload",
	 ...
	 *            用来处理登录和授权的开发者的服务器地址。
	 */
	public void authorize(Activity activity, String[] permissions, final RenrenAuthListener listener, String redirectUrl) {
		if (this.isSessionKeyValid()) {
			listener.onComplete(new Bundle());
			return;
		}
		RenrenDialogListener rdl = RenrenListenerFactory.genWebServerFlowRenrenDialogListener(this, listener,
				redirectUrl);
	...
	private void authorize(Activity activity, String[] permissions, final RenrenDialogListener listener,
	 ...
	 */
	public void authorize(Activity activity, String[] permissions, final RenrenAuthListener listener, int requestCode) {
		// 若开发者提供的权限列表为空，则使用默认权限列表
		if (permissions == null) {
			permissions = DEFAULT_PERMISSIONS;
		}
	...
	public void feed(Context context, FeedParam feedParam, final RenrenFeedListener listener) {
		...
		RenrenDialogListener rdl = RenrenListenerFactory.genFeedRenrenDialogListener(this, listener);
	 ...
	 */
	public void widgetDialog(Context context, Bundle params, final RenrenWidgetListener listener, String type) {
		String url = this.checkUrl(type);
		params.putString("display", "touch");
		params.putString("return", "redirect");
		params.putString("redirect_uri", WIDGET_CALLBACK_URI);
		if (this.isAccessTokenValid()) {
			params.putString("access_token", this.accessTokenManager.getAccessToken());
		}
		RenrenDialogListener rdl = RenrenListenerFactory.genRenrenWidgetDialogListener(this, listener);
	 ...
	 * @param requestCode
	 */
	public void widgetDialog(Activity activity, Bundle params, final RenrenWidgetListener listener, String type,
			int requestCode) {
		String url = this.checkUrl(type);
		if (this.isAccessTokenValid()) {
			params.putString("access_token", this.accessTokenManager.getAccessToken());
	 ...
	 * @param showTitle
	 */
	private void dialog(Context context, final RenrenDialogListener listener, Bundle params, String url,
			boolean showTitle) {
	 ...
	 * @throws RenrenException
	 */
	public void publishStatus(Activity activity, final AbstractRequestListener<StatusSetResponseBean> listener)
			throws RenrenException {
		StatusHelper helper = new StatusHelper(this);
	 ...
	 * @throws Throwable
	 */
	public FriendsGetFriendsResponseBean getFriends(FriendsGetFriendsRequestParam param) throws RenrenException,
			Throwable {
		FriendsHelper helper = new FriendsHelper(this);
		return helper.getFriends(param);
	}
	 ...
	 */
	public AlbumGetResponseBean getAlbums(AlbumGetRequestParam albumRequest) throws RenrenException, Throwable {
