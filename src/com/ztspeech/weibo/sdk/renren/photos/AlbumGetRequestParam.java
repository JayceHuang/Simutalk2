	...
	public Bundle getParams() throws RenrenException {
		...
		if (this.aids != null && !"".equals(this.aids)) {
			...
			if (length >= 10) {
				...
				throw new RenrenException(RenrenError.ERROR_CODE_PARAMETER_EXTENDS_LIMIT, "同时获取的相册数不能大于10个",
						"同时获取的相册数不能大于10个");
			}
			...
			for (int i = 0; i < length; i++) {
				...
				throw new RenrenException(RenrenError.ERROR_CODE_ILLEGAL_PARAMETER, "不合法的相册aid", "不合法的相册aid");
			}
