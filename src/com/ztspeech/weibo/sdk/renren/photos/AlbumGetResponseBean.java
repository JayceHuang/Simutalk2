...
import com.ztspeech.weibo.sdk.renren.common.ResponseBean;
			...
			try {
				...
				for (int i = 0; i < size; i++) {
					...
					if (object != null) {
						...
						album.setVisible(AlbumPrivacyType.parse(object.optInt("visible")));
						album.setUpdateTime(sdf.parse(object.optString("update_time")));
						album.setCreateTime(sdf.parse(object.optString("create_time")));
