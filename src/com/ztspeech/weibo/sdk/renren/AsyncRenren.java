...
public class AsyncRenren {
	 ...
	 * 
	 * @param parameters
	 *            注意监听器中不在主线程中执行，所以不能在监听器中直接更新代码。
	 * @param listener
	 */
	 ...
	 */
	public void publishPhoto(final long albumId, final byte[] photo, final String fileName, final String description,
	...
	/**
	 * 发状态，异步调用status.set 参见http://wiki.dev.renren.com/wiki/Status.set
	 * 
	 * @param status
	 *            要发布的状态
	 * @param listener
	 ...
	 *            若超出了长度，是否自动截短至140个字
	 */
	public void publishStatus(StatusSetRequestParam status, AbstractRequestListener<StatusSetResponseBean> listener,
			boolean truncOption) {
	...
	/**
	 * 发送新鲜事<br>
	 * 异步调用feed.publishFeed接口 参见http://wiki.dev.renren.com/wiki/Feed.publishFeed
	 * 
	 * @param feed
	 *            要发布的新鲜事
	 * @param listener
	 ...
	 *            若超出了长度，是否自动截短至限制的长度
	 */
	public void publishFeed(FeedPublishRequestParam feed, AbstractRequestListener<FeedPublishResponseBean> listener,
			boolean truncOption) {
	 ...
	 */
	public void createAlbum(AlbumCreateRequestParam album, AbstractRequestListener<AlbumCreateResponseBean> listener) {
	 ...
	 * 
	 */
	public void getAlbums(AlbumGetRequestParam album, AbstractRequestListener<AlbumGetResponseBean> listener) {
	 ...
	 */
	public void publishPhoto(PhotoUploadRequestParam photo, AbstractRequestListener<PhotoUploadResponseBean> listener) {
	 ...
	 *            接口调用的监听器
	 */
	public void getFriends(FriendsGetFriendsRequestParam param,
