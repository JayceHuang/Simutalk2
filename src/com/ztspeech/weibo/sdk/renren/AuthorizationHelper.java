...
public class AuthorizationHelper {
	 ...
	 * 注意：
	 * <p>
	 * 使用者需要在AndroidManifest.xml中声明Activity如下：
	 * <p>
	 ...
	 *            认证结果的监听器
	 */
	public synchronized static void check(Renren renren, Activity activity, String[] permissions,
			...
			if (bundle != null) {
				if (bundle.containsKey(KEY_RESPONSE_TYPE)) {
					...
					if (code.equals(AUTH_COMPLETE)) {
						...
						listener.onRenrenAuthError(new RenrenAuthError(error, errorDescription, errorUri));
			...
			renren.authorize(this, permissions, new RenrenAuthListener() {
				...
				public void onRenrenAuthError(RenrenAuthError renrenAuthError) {
					...
					if (renrenAuthError != null) {
						...
						bundle.putString(KEY_AUTH_ERROR_DESCRIPTION, renrenAuthError.getErrorDescription());
